...
import com.aanglearning.principalapp.dao.AlbumImageDao;
import com.aanglearning.principalapp.dao.DeletedAlbumImageDao;
...
import com.aanglearning.principalapp.util.GridSpacingItemDecoration;
    ...
    private void saveBitmapToFile() {
        try {
            ...
            File dir = new File(Environment.getExternalStorageDirectory().getPath(),
                    "Shikshitha/Principal/" + teacher.getSchoolId());
            if (!dir.exists()) {
                dir.mkdirs();
            }
    ...
    public void albumImagesDeleted(ArrayList<DeletedAlbumImage> albumImages) {
        ...
        for(DeletedAlbumImage deletedAlbumImage: albumImages) {
            File file = new File(Environment.getExternalStorageDirectory().getPath(),
                    "Shikshitha/Principal/" + teacher.getSchoolId() + "/" + deletedAlbumImage.getName());
            if(file.exists()) {
                file.delete();
            }
        }
